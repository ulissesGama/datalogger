...
const long interval = 80; // Intervalo desejado entre leituras em milissegundos
int readingsCount = 0; // Contador de leituras por segundo
int previousSecond = 0;           // Variável para armazenar o tempo anterior
void setup(void)
{
